...
<div class="posts_page <?php echo esc_attr( get_post_meta( get_the_ID(), '_smart_meta_sidebar', true ) ); ?> <?php if( $this_catname){ } else { echo 'no-cat-name'; } ?>">
    <div class="container">
        <div class="content">
            <div class="news">
        ...
        ?>
                ...
                <?php
                            ...
                            the_posts_pagination( array(
                                'prev_text'          => pll__('prev_page','Smart'),
                                'next_text'          => pll__('next_page','Smart'),
