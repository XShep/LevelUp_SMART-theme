...
<tr class="form-field">
     ...
     <td>
            <textarea name="event_modal_options[modal_styles]" id="event_modal_options[modal_styles]" class="large-text code" style="width: 100%;" rows="12" placeholder="Здесь стили для формы"><?php echo $options_modal['modal_styles'];?></textarea>
...
<div class="event_modal" style="background: url(<?php echo $options_modal['background_url'];?>) center no-repeat; background-size: cover;">
    ...
    <div id="setCookie" class="close-icon">
        <img src="https://uaitsmart.com/wp-content/uploads/2019/07/cancel2.svg" alt="">
    </div>
</div>
